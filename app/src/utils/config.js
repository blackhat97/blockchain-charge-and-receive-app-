...
class Config {
    constructor() {
        this.restServer = {};
        this.restServer.webSocketURL = "ws://companya.twbuddy.com:3000";
        this.restServer.httpURL = "http://companya.twbuddy.com:3000/api";
        this.restServer.explorer = "http://companya.twbuddy.com:3000/explorer";

        this.playground = {};
        this.playground.name = "Hyperledger Composer";
        this.playground.docURL = "https://hyperledger.github.io/composer/latest/";
        this.playground.deployedURL = "http://companya.twbuddy.com:8080";
